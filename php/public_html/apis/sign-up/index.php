...
/**
 * api for signing up to SCP
 *
 * @author hmiltenberger <hannahmilt@gmail.com>
 **/
...
try {
	...
	if($method === "POST") {
		...
		$hash = password_hash($requestObject->profilePassword, PASSWORD_ARGON2I, ["time_cost" => 8]);
		...
		//building the activation link that can travel to another server and still work. This is the link that will be clicked
		...
		$message = <<< EOF
<h2>Welcome to SCP.</h2>
<p>In order to start requesting items you must confirm your account </p>
